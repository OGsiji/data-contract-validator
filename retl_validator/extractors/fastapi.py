...
class FastAPIExtractor:
    ...
    def _analyze_model(self, model_class: type) -> Optional[Dict[str, Any]]:
        ...
        for field_name, field_info in model_fields.items():
            column_info = self._analyze_field(field_name, field_info, type_hints.get(field_name))
    ...
    def _analyze_field(self, field_name: str, field_info: FieldInfo, type_hint: Any) -> Dict[str, Any]:
